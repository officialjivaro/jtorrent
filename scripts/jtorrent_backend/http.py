    ...
    def _check_domain(self, url: str) -> None:
        ...
        for blocked in self.settings.blocked_domains:
            ...
            if host == blocked or host.endswith("." + blocked):
                raise BlockedDomainError(f"Blocked source domain in config or fetched URL: {host}")
...
def make_http_settings(settings: dict, blocked_domains: Iterable[str]) -> HttpSettings:
